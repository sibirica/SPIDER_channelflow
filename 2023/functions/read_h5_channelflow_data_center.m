function [P, P0, U, V, W, x, y, z, t] = read_h5_channelflow_data_center()
  %{
  PURPOSE:
  ...
  pressure_file = "h5_cutouts/pressure_middle1.h5";
  velocity_file = "h5_cutouts/velocity_middle1.h5";
  ...
  for t = 1:Lt
    %tt = 128 + t;
    tt = 2000 + t; %for data set 1
    %tt = 1000 + t; %for data set 2
    %tt = 500 + t; %data set 3,4,5
